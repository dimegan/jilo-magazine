		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'mh-newsdesk-lite'); ?></strong>
					...
					<a href="https://www.facebook.com/MHthemes" target="_blank"><?php _e('Facebook', 'mh-newsdesk-lite'); ?></a>
					<a href="https://twitter.com/MHthemes" target="_blank"><?php _e('Twitter', 'mh-newsdesk-lite'); ?></a>
					<a href="https://www.youtube.com/user/MHthemesEN" target="_blank"><?php _e('YouTube', 'mh-newsdesk-lite'); ?></a>
				</p>
			</div>
			<hr>
